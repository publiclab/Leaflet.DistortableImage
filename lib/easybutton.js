L.Control.EasyButtons = L.Control.extend({
    ...
    onAdd: function () {
        ...
        // not actually using supplied scope, 
        // but at least you get the this.scope method
        L.DomEvent.addListener(this.link, 'click', this._click, this.scope);
...
L.easyButton = function( btnIcon , btnFunction , btnTitle , btnMap , btnScope ) {
  ...
  if (btnScope) newControl.scope = btnScope;
